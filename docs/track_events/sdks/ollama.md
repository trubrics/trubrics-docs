To get started collecting events in your application using Ollama, our SDKs have methods to automate AI event collection with a single line of code.
...
Now start tacking prompts, generations and tool calls from Ollama by using the withProperties wrapper:
