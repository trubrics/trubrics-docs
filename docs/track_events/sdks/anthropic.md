To get started collecting events in your application using Anthropic, our SDKs have methods to automate AI event collection with a single line of code.
...
Now start tacking prompts, generations and tool calls from Anthropic by using the withProperties wrapper:
...
=== "Javascript/Node.js"
    ...
    ``` ts
    --8<-- "utils/code_snippets/js/anthropic_withProperties.js"
    ```
